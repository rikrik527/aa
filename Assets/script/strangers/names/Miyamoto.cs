...
public class Miyamoto : Strangers, YushanAbility
{
    ...
    {
        base.OnMouseDown();
        Debug.Log("miyam oto mouse down");

    }
    public void Damage()
    {
        Attentions++;
        Debug.Log("damage on miyamoto" + Attentions);
        if (Attentions > 5)
        {
            Destroy(gameObject);
        }
    ...
    public void AnalyzeInfo()
    {
        ...
        Debug.Log("miyamoto running analyzinginfo");
